      ...
      >
        <div className=" w-[650px] pl-32 xl:pl-60 flex flex-col justify-center">
          ...
          <div className="flex flex-row items-center">
            <button className="w-full p-3 text-teal-400 border-2 border-teal-400 font-semibold rounded-md mr-5">
              Hacer pedido
            </button>
      ...
      <section className="mb-32 w-full mx-auto md:w-[600px] lg:w-[960px] flex flex-col lg:flex-row items-center">
        ...
        <div className="basis-1/2 lg:px-8 xl:px-16">
          ...
          <p className="mb-10">
            ...
            contenedor orgánico. Todo es sostenible, biodegradable, compostable
      ...
      <section className="mb-32 w-full mx-auto md:w-[600px] lg:w-[960px] flex flex-col lg:flex-row-reverse items-center">
        ...
        <div className="basis-1/2 lg:px-8 xl:px-16">
          ...
          <p className="mb-10">
            ...
            medioambiente y reforzamos nuestro compromiso con Auara, el agua
            100% social y con valores.
          </p>
        ...
        <div className="md:w-[500px] lg:w-full xl:w-[1200px] grid lg:grid-cols-3 gap-5">
          <div className="flex flex-col items-center mb-20">
            ...
            <p>
              ...
              <strong> en la oficina o en casa</strong>, refuerza el compromiso
              y mejora el engagement con lxs empleadxs.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center mb-20">
            ...
            <p>
              ...
              un aumento de la felicidad. Y la felicidad de tus empleadxs es una
      ...
      <section className="mb-32 flex flex-col items-center">
        ...
        <div className="sm:w-[500px] lg:w-full xl:w-[1200px] grid lg:grid-cols-3 lg:gap-5 xl:gap-10">
          ...
          <div className="mb-20">
            ...
            <p className="mb-5">
              Aceptamos pagos con tarjeta, con todo tipo de tiquets restaurante
              o, si tenemos acuerdo con tu empresa, con factura mensual.
            </p>
          </div>
        </div>
